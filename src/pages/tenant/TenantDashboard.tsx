...
export default function TenantDashboard() {
  return (
    <TenantLayout title="Hello, Thomas">
      <p className="text-gray-400 mt-1 mb-6 md:col-span-full">Room 1</p>

      <Card className="p-4 bg-white rounded-xl mb-4 md:mb-0">
      ...
      <Card className="p-4 bg-white rounded-xl md:h-[fit-content]">
